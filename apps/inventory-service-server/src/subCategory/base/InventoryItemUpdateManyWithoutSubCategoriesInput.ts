...
@InputType()
class InventoryItemUpdateManyWithoutSubCategoriesInput {
...
export { InventoryItemUpdateManyWithoutSubCategoriesInput as InventoryItemUpdateManyWithoutSubCategoriesInput };
