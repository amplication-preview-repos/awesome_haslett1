...
@InputType()
class InventoryItemCreateNestedManyWithoutSubCategoriesInput {
...
export { InventoryItemCreateNestedManyWithoutSubCategoriesInput as InventoryItemCreateNestedManyWithoutSubCategoriesInput };
