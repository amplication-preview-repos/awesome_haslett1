...
class FileUploadUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProgressTrackerUpdateManyWithoutFileUploadsInput,
  })
  @ValidateNested()
  @Type(() => ProgressTrackerUpdateManyWithoutFileUploadsInput)
  @IsOptional()
  @Field(() => ProgressTrackerUpdateManyWithoutFileUploadsInput, {
    nullable: true,
  })
...
export { FileUploadUpdateInput as FileUploadUpdateInput };
