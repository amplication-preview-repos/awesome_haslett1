...
@InputType()
class ProgressTrackerCreateNestedManyWithoutFileUploadsInput {
...
export { ProgressTrackerCreateNestedManyWithoutFileUploadsInput as ProgressTrackerCreateNestedManyWithoutFileUploadsInput };
